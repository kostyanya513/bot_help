LEXICON: dict[str, str] = {
    '/start': '<b>Привет, солнце, это Горгона!</b>\n\n'
              'Расскажи мне, что у тебя случилось и мы сможем найти выход вместе!\n\n'
              'Для начала мне надо знать находишься ли <b>ты сейчас в безопасности?</b>\n'
              'Укажи, пожалуйста, в какой стране и городе ты находишься сейчас?\n\n'
    ...
    'another_way': 'Включи геолокацию в настройках телефона\n'
                   'Зайди в любое приложение с картами или через ссылки в браузере:\n'
                   'google maps\n'
                   'Apple maps',
    ...
    'description_territory': 'Хорошо, давай попробуем по описанию\n'
                             'Посмотри вокруг. Видишь ли ты таблички с названиями улиц, номера зданий, магазины, остановки транспорта?',
    'help_me': f'Для начала мне надо знать, ты сейчас находишься в безопасности?',
    'share_geo_bot': f'Давай попробуем самое легкое:\n'
                     f'Telegram позволяет пользователям отправить свою текущую геолокацию.\n'
                     f'Инструкция для пользователя:\n'
                     f'Нажмите на кнопку «скрепка» (иконка вложений) .\n'
                     f'Выберите «Геопозиция».\n'
                     f'Отправьте свою текущую локацию или включите «живую геолокацию», если нужно отслеживать перемещение.',
    'contact_emergency_services': 'Определение через звонок в экстренные службы\n'
                                  'Номер экстренной службы (112 или 911).\n'
                                  'Опиши ситуацию и запроси помощь в определении местоположения. Операторы могут использовать данные сотовой сети для примерного определения местоположения.',
    'correct_information': 'Пожалуйста скопируй сообщение и внеси изменения',
    'change_data': 'Вот данные о тебе:',
    'change': 'Если надо что-то поменять выбери переменную и отправь измененный параметр',
    ...
    'enter_new_value_info': 'Введите информацию о месте своего пребывания',
    ...
    'find_police_station': 'Полиция\n'
                           'Вот список полицейских участков на основе геопозиции:',
    'find_medical_center': 'Мед помощь\n'
                           'Вот список мед учреждений на основе геопозиции:',
    'give_access_location': 'Разреши доступ к геоположению',
    'how_call': 'SOS телефоны\n'
                'Это как объяснение',
    'help_centers': 'Центры помощи\n'
                    'На основе вашей геопозиции вот центры помощи для вас:',
    'legal_assistance': 'Скажите, на каком основании вы находитесь в этой стране и городе?',
    'manipulative_techniques': 'Манипулятивные техники для обезвреживания насильника',
    'need_help': 'Для точной помощи, мне необходимо знать твое местоположение, давай я помогу тебе его определить?',
    'not_share_geo': 'Для точной помощи, мне необходимо знать твое местоположение, ты уверена что не хочешь делиться гео',
    'not_share_location': 'Нет местоположения\n'
                          'К сожалению нам не получилось узнать твое местоположение, я настоятельно рекомендую обратиться в службу спасения, особенно если есть угроза здоровью',
    'need_police': 'Полиция\n'
                   'Вы можете задать свой вопрос и я отвечу на него или же предоставить данные к вашему местоположению, чтобы я смогла найти ближайшие к вам участки полиции',
    'need_medical_help': 'Мед помощь\n'
                         'Вы можете задать свой вопрос и я отвечу на него или же я могу найти ближайший работающий центр мед помощи',
    ...
    'points_wifi_bluetooth': 'Хорошо, давай попробуем по описанию\n'
                             'Определите ближайшие точки Wi-Fi или Bluetooth (могут быть видны в настройках). Их можно использовать для локального определения местоположения.',
    'phone_list': 'SOS телефоны:\n',
    'psycholog_support': 'Психологическая поддержка\n'
                         'Опишите свое состояние и какая помощь вам требуется',
    'psychological_support': 'Психологическая поддержка\n'
                             'Опишите свое состояние и какая помощь вам требуется',
    'phone_list_1': 'SOS телефоны:\n'
                    'гео не указан:позвоните по общему номеру службы спасения 911 или 112\n'
                    'Вы хотите позвонить через меня?',
    'repeat_main_menu': 'Укажи свое местоположение',
    ...
    'too_not_share_geo': 'Для точной помощи, мне необходимо знать твое местоположение, ты уверена что не хочешь делиться гео',
    'time_point_departure': 'Хорошо, давай попробуем по описанию\n'
                            'Сколько времени ты уже в пути?\n'
                            'Помнишь ли ты отправную точку?\n'
                            'Это может помочь приблизительно вычислить твоё местоположение.',
    ...
    'your_question': 'Задайте свой вопрос и я отвечу на него используя мое обучение и базы знаний',
}

LEXICON_COMMANDS: dict[str, str] = {
    '/main_menu': 'главное меню',
    '/clean_history': 'очищает историю',
    '/hide_bot': 'переносит в тг канал @kulinariya_retsept и очищает историю у user',
    '/change_data': 'изменить данные - выводит данные со всех переменных заполненных',
}
